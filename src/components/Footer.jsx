    ...
    <>
      ...
      >
        <article className='flex my-2 items-center justify-around font-bold'>
          <a href='/Second' className=' rounded-2xl border-4 bg-purple-300 border-purple-500 w-56 h-auto flex flex-col items-center justify-center hover:scale-110 duration-100'>
            <span>Crear Producto</span>
          </a>
          <a href='/' className='flex flex-col rounded-2xl border-4 bg-green-300 border-green-400 w-56 h-auto items-center justify-center hover:scale-110 duration-100'><Home /><span>Inicio</span></a>
